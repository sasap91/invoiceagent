...
Latest evidence: **233 tests passed with two intentionally opt-in real-Tesseract smokes skipped** in the default run; the enabled focused Tesseract/UI/reward subset passes **52/52**. Offline acceptance is **9/9**, live acceptance is **10/10**, all **6/6** action/governance attacks are blocked, and all **8/8** receipt/proof attacks are blocked.
