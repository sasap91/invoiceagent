...
def test_source_citations_point_at_the_code_they_claim() -> None:
    ...
    Any edit to a cited file shifts those ranges silently, so the panel would
    show the wrong function under a confident label -- a credibility bug in the
    one panel built to prove the source is real.
    """
